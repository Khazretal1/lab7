...
clock_img = pygame.image.load("C:\images\clock.png")
minute_hand_img = pygame.image.load("C:\images\min_hand.png")
second_hand_img = pygame.image.load("C:\images\sec_hand.png")
